								...
								<td><center>
									<?php 
										...
										if($checkInDate == $today){
											echo '<a class = "btn btn-success" href = "confirm_reserve.php?transaction_id='.$fetch["transaction_id"].'"><i class = "glyphicon glyphicon-check"></i> Check In</a>';
										}
									?>
									
									
									<a class = "btn btn-danger" onclick = "confirmationDelete(); return false;" href = "delete_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-trash"></i> Discard</a></td>
							</tr>
							<?php
								}
							?>
