	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				?>
				<br />
				<form method = "POST" enctype = "multipart/form-data" action = "save_form_checkout.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<div class = "form-inline" style = "float:left; margin-left:1px;">
